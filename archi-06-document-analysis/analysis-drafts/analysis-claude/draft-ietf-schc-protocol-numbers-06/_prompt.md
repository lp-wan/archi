...
Write your three deliverables as files, using exactly these paths:
  ...
  /Users/apelov/Work/SCHC/archi/schc_drafts/analysis-claude/draft-ietf-schc-protocol-numbers-06/verdicts.md
  /Users/apelov/Work/SCHC/archi/schc_drafts/analysis-claude/draft-ietf-schc-protocol-numbers-06/schc-architecture-edits.md
  /Users/apelov/Work/SCHC/archi/schc_drafts/analysis-claude/draft-ietf-schc-protocol-numbers-06/terminology-migration.diff
...
- **Draft under study:** `draft-ietf-schc-protocol-numbers-06`
- **Draft URL or text:** `/Users/apelov/Work/SCHC/archi/schc_drafts/draft-ietf-schc-protocol-numbers-06.txt`
...
- **If None:** the file contains only a title and the single statement:
  `No modification to SCHC Architecture -06 is required for draft-ietf-schc-protocol-numbers-06.`
...
```
# SCHC Architecture -06 edits needed for draft-ietf-schc-protocol-numbers-06
