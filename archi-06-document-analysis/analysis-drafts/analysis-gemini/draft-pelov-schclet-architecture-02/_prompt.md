...
Write your three deliverables as files, using exactly these paths:
  ...
  /Users/apelov/Work/SCHC/archi/schc_drafts/analysis/draft-pelov-schclet-architecture-02/verdicts.md
  /Users/apelov/Work/SCHC/archi/schc_drafts/analysis/draft-pelov-schclet-architecture-02/schc-architecture-edits.md
  /Users/apelov/Work/SCHC/archi/schc_drafts/analysis/draft-pelov-schclet-architecture-02/terminology-migration.diff
...
- **Draft under study:** `draft-pelov-schclet-architecture-02`
- **Draft URL or text:** `/Users/apelov/Work/SCHC/archi/schc_drafts/draft-pelov-schclet-architecture-02.txt`
...
- **If None:** the file contains only a title and the single statement:
  `No modification to SCHC Architecture -06 is required for draft-pelov-schclet-architecture-02.`
...
```
# SCHC Architecture -06 edits needed for draft-pelov-schclet-architecture-02
