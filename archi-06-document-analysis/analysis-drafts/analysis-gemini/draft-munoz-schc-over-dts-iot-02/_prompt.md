...
Write your three deliverables as files, using exactly these paths:
  ...
  /Users/apelov/Work/SCHC/archi/schc_drafts/analysis/draft-munoz-schc-over-dts-iot-02/verdicts.md
  /Users/apelov/Work/SCHC/archi/schc_drafts/analysis/draft-munoz-schc-over-dts-iot-02/schc-architecture-edits.md
  /Users/apelov/Work/SCHC/archi/schc_drafts/analysis/draft-munoz-schc-over-dts-iot-02/terminology-migration.diff
...
- **Draft under study:** `draft-munoz-schc-over-dts-iot-02`
- **Draft URL or text:** `/Users/apelov/Work/SCHC/archi/schc_drafts/draft-munoz-schc-over-dts-iot-02.txt`
...
- **If None:** the file contains only a title and the single statement:
  `No modification to SCHC Architecture -06 is required for draft-munoz-schc-over-dts-iot-02.`
...
```
# SCHC Architecture -06 edits needed for draft-munoz-schc-over-dts-iot-02
